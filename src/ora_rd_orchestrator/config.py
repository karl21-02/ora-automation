...
# Convergence pipeline constants
CONVERGENCE_LEVEL1_MAX_ROUNDS = 5
CONVERGENCE_LEVEL2_MAX_ROUNDS = 3
CONVERGENCE_LEVEL3_MAX_ROUNDS = 3
CONVERGENCE_THRESHOLD_DEFAULT = 0.15

# Risk threshold constants
RISK_THRESHOLD_HIGH = 8.0
RISK_THRESHOLD_MEDIUM = 6.0
CONSENSUS_FUZZY_MATCH_THRESHOLD = 0.8
